...
class SpeedrunMapBrowseGui(window: Window, title: String, maps: List<MinecraftMapMeta>, instance: BasicInstance) : SpeedrunMapBrowseDialog(window) {
    init {
        this.title = title
    ...
    class MapPanel(parent: SpeedrunMapBrowseGui, map: MinecraftMapMeta, instance: BasicInstance) : JPanel() {
        init {
